...
$expectedReason = 'Playwright refund request for paid order';
...
$checks = [
    'status_refund_requested' => $order->status === 'refund_requested',
    'refund_status_requested' => $order->refund_status === 'requested',
    'refund_reason_matches' => $order->refund_reason === $expectedReason,
