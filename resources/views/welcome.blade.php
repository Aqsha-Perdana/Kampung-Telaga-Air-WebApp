      ...
      <div>
        <div class="brand-logo d-flex align-items-center justify-content-between">
          <a href="./index.html" class="text-nowrap logo-img"><br>
            <img src="../assets/images/logos/primary-logo.png" width="170" alt="" />
          </a>
        ...
        <nav class="sidebar-nav scroll-sidebar" data-simplebar="">
          <ul id="sidebarnav">
            ...
            <li class="sidebar-item {{ request()->routeIs('destinations.*') ? 'active' : '' }}">
              <a class="sidebar-link" href="{{ route('destinations.index') }}" aria-expanded="false">
                <span>
