...
<head>
    ...
    <title>Reset Password - Kampung Telaga Air</title>
    ...
    <div class="login-wrapper">
        <div class="left-section">
            ...
            <div class="welcome-content">
                ...
                <p>Use a strong password so your visitor account stays protected.</p>
            </div>
        </div>
        ...
        <div class="right-section">
            <div class="login-container">
                <div class="login-header">
                    ...
                    <p>Set a new password for your visitor account.</p>
                </div>
                ...
                <form action="{{ route('wisatawan.password.update') }}" method="POST">
                    @csrf
