<div class="container-fluid">
    @include('admin.paket-wisata.shared.page-header', [
        ...
        'subtitle' => 'Refine package details, update included resources, and review the final selling price before publishing changes.',
    ])
    ...
    <form action="{{ route('paket-wisata.update', $paketWisata->id_paket) }}" method="POST" id="paketForm" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        ...
        <x-admin.form-actions
            ...
            back-label="Cancel"
            submit-label="Update Tour Package"
