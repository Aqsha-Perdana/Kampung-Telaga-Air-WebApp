                ...
                @endif
                    <div class="destination-card">
                        @if($destinasi->fotos->count() > 0)
                            <img src="{{ asset('storage/'.$destinasi->fotos->first()->foto) }}" alt="{{ $destinasi->nama }}">
                        @else
                            <img src="https://images.unsplash.com/photo-1506905925346-21bda4d32df4?w=600" alt="{{ $destinasi->nama }}">
                        @endif
                        ...
                        <div class="card-body">
                            ...
                            @if($destinasi->footage360->count() > 0)
                                <p class="small text-muted">
                                    ...
                                    {{ $destinasi->footage360->count() }} lokasi tersedia
                                </p>
                            @endif
                        </div>
                    </div>
